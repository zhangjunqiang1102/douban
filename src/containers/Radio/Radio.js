    ...
    return <div className="radio" onClick={this.dialogShow}>
      ...
      <div className="radio-publish">
        <div className="radio-login clearfix">
          ...
          {this.props.session.user ? <div className="radio-holder">分享我的点滴生活...</div> :
          ...
          return list.is_status_ad ? <li key={index} className="radio-lis">
            ...
            <div className="radio-content">
              <div className="radio-title">
                <a
                  href={list.entities.length === 2 ? list.entities[0].uri : null}>{list.entities.length === 2 ? "#" + list.entities[0].title + "#" : null}</a>
                {list.text}
                <a
                  href={list.entities.length === 2 ? list.entities[1].uri : list.entities[0].uri}> {list.entities.length === 2 ? list.entities[1].title : list.entities[0].title}</a>
              </div>
              ...
              <div className="radio-info clearfix">
                ...
                <Link to={"/count/detail/" + list.id} className="iconfont icon-pinglun">
                  <span>{list.comments_count}</span></Link>
            ...
            <div className="radio-btn-dou">
              <a href="https://m.douban.com/people/95805238/"><img
                src="https://img3.doubanio.com/icon/up95805238-16.jpg" alt=""/></a>
            </div>
            <div className="radio-desc">
      ...
      <div className="radio-wrapper-dialog" ref={x => this.dia = x}>
        ...
        <div className="radio-dialog dialog">
          ...
          <a
            href="https://www.douban.com/doubanapp/card/get_app?from=mdouban&client_uri=douban%3A%2F%2Fdouban.com%2Ftimeline&model=B&copy=1&page=status&channel=card_popup_continue"
