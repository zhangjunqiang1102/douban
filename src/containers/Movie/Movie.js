                        ...
                        <div className="section-content">
                            <ul>
                                <li style={{"borderColor": "#4F9DED"}}>
                                    <a href="https://m.douban.com/doulist/968362/"
                                                                          style={{"color": "#4F9DED"}}>同时入选IMDB250和豆瓣电影250的电影</a>
                                </li>
                                <li style={{"borderColor": "#42BD56"}}>
                                    <a href="https://m.douban.com/doulist/16002/"
                                                                          style={{"color": "#42BD56"}}>带你进入不正常的世界</a>
                                </li>
                                <li style={{"borderColor": "#FFAC2D"}}>
                                    <a href="https://m.douban.com/doulist/190343/"
                                                                          style={{"color": "#FFAC2D"}}>用电【影】来祭奠逝去的岁月</a>
                                </li>
                                <li style={{"borderColor": "#3BA94D"}}>
                                    <a href="https://m.douban.com/doulist/1125971/"
                                                                          style={{"color": "#3BA94D"}}>女孩们的故事【电影】</a>
                                </li>
                                ...
                                <li style={{"borderColor": "#CC3344"}}><a href="https://m.douban.com/doulist/458087/"
                                                                          style={{"color": "#CC3344"}}>经典韩国电影——收集100部</a>
                                </li>
                            </ul>
                        </div>
                    </section>
